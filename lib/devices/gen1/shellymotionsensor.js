...
const shellymotionsensor = {
  'sensor.battery': {
    ...
    mqtt: {
      ...
      mqtt_publish_funct: (value) => { return value ? JSON.parse(value).bat.value : undefined; }
    },
    common: {
  ...
  'sensor.lux': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/<mqttprefix>/status',
      mqtt_publish_funct: (value) => { return value ? JSON.parse(value).lux.value : undefined; }
    },
    common: {
      'name': 'Illuminance',
      'type': 'number',
  ...
  'sensor.vibration': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/<mqttprefix>/status',
      mqtt_publish_funct: (value) => { return value ? JSON.parse(value).sensor.vibration : undefined; }
    },
    common: {
      'name': 'Vibration',
      'type': 'boolean',
  ...
  'sensor.motion': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/<mqttprefix>/status',
      mqtt_publish_funct: (value) => { return value ? JSON.parse(value).sensor.motion : undefined; }
    },
    common: {
      'name': 'Motion',
      'type': 'boolean',
